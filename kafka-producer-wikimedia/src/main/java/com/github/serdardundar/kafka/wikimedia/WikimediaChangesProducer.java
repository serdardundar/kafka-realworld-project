package com.github.serdardundar.kafka.wikimedia;
...
public class WikimediaChangesProducer {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        properties.setProperty(ProducerConfig.RETRIES_CONFIG, Integer.toString(Integer.MAX_VALUE - 1)); //same as setting -1
